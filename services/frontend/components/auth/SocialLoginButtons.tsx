  ...
  return (
    <div className="space-y-2">
      <a
        ...
        className="flex w-full items-center justify-center gap-2 rounded-xl border border-ink-700 bg-ink-950 px-3 py-2.5 text-sm font-medium text-ink-100 transition hover:border-ink-600 hover:bg-ink-900"
      >
